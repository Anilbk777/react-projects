...
const CreateTask = () => {
  return (
    <div>
      <div className=" flex justify-center flex-col ml-[34vw] mr-[26vw] p-4 rounded-md bg-[#1c1c1c]">
        ...
        <form className="flex flex-col items-center justify-center ">
          <div>
            ...
            <input
              ...
              className="bg-gray-600 w-[25vw] px-4 py-1 outline-none rounded-md mb-5 placeholder:text-gray-400"
            />
          </div>
          <div>
            ...
            <textarea
              ...
              className="bg-gray-600 resize-none w-[25vw] px-4 py-1 outline-none  rounded-md mb-5 placeholder:text-gray-400"
            ></textarea>
          </div>
          <div>
            ...
            <input
              type="date"
              className="bg-gray-600 w-[25vw] px-4 py-1 outline-none rounded-md mb-5 "
            />
          </div>
          <div>
